        ...
        <Grid container justifyContent="center">
          <Grid item xs={8}>
            ...
            <Typography className={'bodyText'} align="center">
              Be a voice for Greenly in your community! This can be as simple as a table at a town fair or a flyer at a
              coffee shop -- read more about what it means to be an{' '}
              <Link
                href="/editor"
                target="_blank"
