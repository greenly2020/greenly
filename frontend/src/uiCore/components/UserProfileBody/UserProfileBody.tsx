...
export const UserProfileBody = forwardRef<HTMLElement, UserProfileBodyProps>(
  (props, _) => {
    const { user } = props;
    ...
    const profileLink = formatProfileLink(user.profileLink || '');
